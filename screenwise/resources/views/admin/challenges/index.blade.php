                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" style="gap:8px">
                                <a href="{{ route('admin.challenges.edit', $ch) }}" class="btn btn-sm" style="background:var(--primary-100);color:var(--primary-700);border:none">✏️ Edit</a>
                                <form method="POST" action="{{ route('admin.challenges.destroy', $ch) }}" onsubmit="return confirm('Hapus challenge ini?')">@csrf @method('DELETE')<button class="btn btn-sm" style="background:var(--danger);color:white;border:none">🗑️ Hapus</button></form>
                            </div>
                        </td>
                    </tr>
                    @endforeach
