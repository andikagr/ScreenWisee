...
<div class="stats-grid" style="grid-template-columns:repeat(auto-fit, minmax(200px, 1fr))">
    <div class="stat-card fade-up"><div class="stat-icon green float-anim">👥</div><div class="stat-value">{{ $totalSiswa }}</div><div class="stat-label">Total Murid</div></div>
    <div class="stat-card fade-up" style="animation-delay:0.1s"><div class="stat-icon blue bounce-anim">👨‍🏫</div><div class="stat-value">{{ $totalGuru }}</div><div class="stat-label">Total Guru</div></div>
    ...
    <div class="stat-card fade-up" style="animation-delay:0.3s"><div class="stat-icon red pulse-ring">⚠️</div><div class="stat-value">{{ $siswaNotTrackedToday }}</div><div class="stat-label">Belum Ngisi Jurnal</div></div>
</div>
...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:24px;margin-bottom:32px">
    ...
    <div class="card fade-up" style="animation-delay:0.2s">
        <div class="card-header"><h3 style="color:var(--accent-pink-dark);font-size:18px">📊 Pre-Test vs Post-Test</h3></div>
...
<div class="stats-grid" style="grid-template-columns:1fr 1fr">
    <div class="card fade-up" style="border:4px solid var(--accent-yellow)">
        <div class="card-header" style="background:var(--accent-yellow);border-bottom:none"><h3 style="color:var(--dark-900);font-size:20px">📋 Ringkasan Aplikasi</h3></div>
        <div class="card-body">
    ...
    <div class="card fade-up" style="animation-delay:0.2s">
        <div class="card-header"><h3 style="color:var(--primary-600);font-size:20px">🚀 Aksi Cepat</h3></div>
        <div class="card-body" style="display:flex;flex-direction:column;justify-content:center">
            <div style="display:grid;gap:16px">
                <a href="{{ route('admin.users.create') }}" class="btn btn-lg" style="background:var(--primary-500);color:white;justify-content:center;box-shadow:0 8px 0 var(--primary-700)">👤 Tambah User Baru</a>
                <a href="{{ route('admin.challenges.create') }}" class="btn btn-lg" style="background:var(--accent-pink-dark);color:white;justify-content:center;box-shadow:0 8px 0 #be185d">🎯 Tambah Tantangan</a>
                <a href="{{ route('admin.reports.index') }}" class="btn btn-lg" style="background:var(--accent-yellow);color:var(--dark-900);justify-content:center;box-shadow:0 8px 0 var(--accent-yellow-dark)">📊 Buka Laporan</a>
            </div>
        </div>
    </div>
</div>
