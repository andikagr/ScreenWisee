...
<div class="card fade-up" style="border:4px solid var(--primary-100);border-radius:32px">
    <div class="card-header" style="background:var(--primary-50);border-bottom:none;padding:24px">
        <h3 style="color:var(--primary-600);font-size:24px">📚 Buku Petualangan (Riwayat Jurnal)</h3>
        <a href="{{ route('siswa.tracking.create') }}" class="btn btn-sm pulse-ring" style="background:var(--accent-pink-dark);color:white;box-shadow:0 4px 0 #be185d">+ Isi Jurnal Baru</a>
    </div>
    <div class="card-body" style="padding:32px">
                    ...
                    <tr>
                        ...
                        <td>
                            @if($t->screenshot_path)
                                <a href="{{ asset('storage/' . $t->screenshot_path) }}" target="_blank" class="btn btn-sm bounce-anim" style="background:var(--accent-yellow);color:var(--dark-900);border:none;box-shadow:0 4px 0 var(--accent-yellow-dark)">📷 Lihat Foto</a>
                            @else - @endif
                        </td>
                    </tr>
                    @endforeach
        ...
        <div class="empty-state fade-up">
            ...
            <h3 style="color:var(--primary-600);font-size:24px">Buku Petualanganmu Masih Kosong Nih!</h3>
            <p style="color:var(--dark-500);font-weight:600;font-size:16px">Yuk, mulai catat aktivitas main HP kamu tiap hari!</p>
            <a href="{{ route('siswa.tracking.create') }}" class="btn btn-lg bounce-anim" style="background:var(--accent-pink-dark);color:white;box-shadow:0 8px 0 #be185d;margin-top:16px">📝 Mulai Misi Pertamamu!</a>
        </div>
        @endif
    </div>
</div>
