...
@section('page-title', '⚙️ Pengaturan Profil')

@section('content')
<div class="card fade-up" style="max-width: 600px; margin: 0 auto; border: 4px solid var(--primary-100); border-radius: 32px;">
    <div class="card-header" style="background: var(--primary-50); border-bottom: none;">
        <h3 class="text-primary" style="margin: 0;">🖼️ Ubah Foto Profil</h3>
    </div>
    <div class="card-body">
        ...
        <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
            ...
            <div style="margin-bottom: 24px;">
                ...
                <div style="position: relative;">
                    ...
                    <div id="fileNameDisplay" style="margin-top: 12px; font-weight: bold; color: var(--primary-600); font-size: 14px; background: var(--primary-50); padding: 8px 12px; border-radius: 8px; border: 2px dashed var(--primary-200); display: none;">
                        📎 <span id="fileNameText">Belum ada file terpilih</span>
                    </div>
                </div>
            ...
            <div style="display: flex; gap: 16px; margin-top: 32px;">
                <button type="submit" class="btn btn-lg bounce-anim" style="flex: 1; justify-content: center; background: var(--primary-500); color: white; box-shadow: 0 6px 0 var(--primary-700);">💾 Simpan Foto</button>
            </div>
        </form>
