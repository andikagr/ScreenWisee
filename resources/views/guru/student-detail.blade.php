...
<div class="stats-grid" style="grid-template-columns:repeat(auto-fit,minmax(200px,1fr))">
    <div class="stat-card fade-up">
        <div class="stat-icon blue float-anim"><i data-lucide="user"></i></div>
    ...
    <div class="stat-card fade-up" style="animation-delay:0.1s">
        <div class="stat-icon green bounce-anim"><i data-lucide="bar-chart"></i></div>
    ...
    <div class="stat-card fade-up" style="animation-delay:0.2s">
        <div class="stat-icon {{ $pretest ? 'green' : 'yellow' }} pulse-ring"><i data-lucide="clipboard-list"></i></div>
    ...
    <div class="stat-card fade-up" style="animation-delay:0.3s">
        <div class="stat-icon {{ $posttest ? 'green' : 'yellow' }} pulse-ring"><i data-lucide="check-circle-2"></i></div>
...
<div class="dashboard-grid-2">
    ...
    <div class="card fade-up" style="animation-delay:0.1s">
        <div class="card-header"><h3 style="color:var(--accent-pink-dark);font-size:18px;display:flex;align-items:center;gap:8px;"><i data-lucide="pie-chart" style="width:20px;height:20px;"></i> Distribusi Aktivitas</h3></div>
...
<div class="card fade-up" style="border:4px solid var(--accent-yellow);border-radius:32px">
    <div class="card-header" style="background:var(--accent-yellow);border-bottom:none; display: flex; justify-content: space-between; align-items: center;">
        <h3 style="color:var(--dark-900);font-size:20px; margin: 0; display:flex; align-items:center; gap:8px;"><i data-lucide="list" style="width:24px;height:24px;"></i> Riwayat Jurnal Siswa</h3>
        <a href="{{ route('export.student.pdf', $siswa->id) }}" class="btn btn-sm pulse-ring" style="background: var(--accent-pink-dark); color: white; border: none; box-shadow: 0 4px 0 #be185d; display:flex; align-items:center; gap:6px;"><i data-lucide="file-text" style="width:16px;height:16px;"></i> Export PDF</a>
    </div>
    <div class="card-body">
            ...
            <table style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>@if($t->screenshot_path)<a href="{{ Str::startsWith($t->screenshot_path, 'http') ? $t->screenshot_path : asset('storage/'.$t->screenshot_path) }}" target="_blank" class="btn btn-sm bounce-anim" style="background:var(--accent-pink-dark);color:white;border:none;display:inline-flex;align-items:center;gap:6px;"><i data-lucide="camera" style="width:14px;height:14px;"></i> Lihat</a>@else - @endif</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
...
<div style="margin-top:24px"><a href="{{ route('guru.dashboard') }}" class="btn btn-lg" style="background:var(--dark-100);color:var(--dark-800);box-shadow:0 8px 0 var(--dark-200);display:inline-flex;align-items:center;gap:8px;"><i data-lucide="arrow-left" style="width:20px;height:20px;"></i> Kembali ke Dashboard</a></div>
@endsection
