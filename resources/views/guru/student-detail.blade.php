            ...
            <table style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>@if($t->screenshot_path)<a href="{{ $t->screenshot_url }}" target="_blank" class="btn btn-sm bounce-anim" style="background:var(--accent-pink-dark);color:white;border:none;display:inline-flex;align-items:center;gap:6px;"><i data-lucide="camera" style="width:14px;height:14px;"></i> Lihat</a>@else - @endif</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
