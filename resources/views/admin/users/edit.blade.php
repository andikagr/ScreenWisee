...
<div class="card" style="max-width:600px">
    <div class="card-header"><h3 style="display:flex;align-items:center;gap:8px;"><i data-lucide="edit-2"></i> Edit User</h3></div>
    <div class="card-body">
        <form method="POST" action="{{ route('admin.users.update', $user) }}">
            ...
            <div class="btn-group"><button type="submit" class="btn btn-primary" style="display:inline-flex;align-items:center;gap:6px;"><i data-lucide="save" style="width:18px;height:18px;"></i> Update</button><a href="{{ route('admin.users.index') }}" class="btn btn-secondary">Batal</a></div>
        </form>
    </div>
</div>
<script>
